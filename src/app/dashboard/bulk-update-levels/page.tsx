    ...
    <div className="flex flex-col min-h-screen bg-background">
       <header className="flex items-center justify-between p-4 border-b bg-card">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-card-foreground">Actualización Masiva de Niveles</h1>
        </div>
      ...
      <main className="flex-1 flex justify-center p-4">
        <Card className="w-full max-w-2xl">
          <CardHeader>
            ...
            <CardDescription>
              Modifica el nivel de cada ejecutivo desde esta tabla. Los cambios se guardarán todos juntos.
            </CardDescription>
          </CardHeader>
          <CardContent>
