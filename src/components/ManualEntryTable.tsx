      ...
      <Table>
        <TableHeader className="bg-primary text-primary-foreground">
           <TableRow>
              ...
              <TableHead rowSpan={2} className={`text-center font-bold text-primary-foreground align-middle`}>Ausentes</TableHead>
          </TableRow>
          <TableRow>
              {ROLES.map(role => (
                <React.Fragment key={role}>
                    <TableHead className={`text-center font-bold text-primary-foreground`}>Real</TableHead>
                    <TableHead className={`text-center font-bold text-primary-foreground`}>Teóri.</TableHead>
                </React.Fragment>
              ))}
          </TableRow>
        </TableHeader>
