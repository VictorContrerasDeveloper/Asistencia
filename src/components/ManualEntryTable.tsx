      ...
      <Table>
        <TableHeader className="bg-primary text-primary-foreground">
           <TableRow className="border-0">
              <TableHead rowSpan={2} className={`sticky left-0 bg-primary border-b border-primary font-bold text-primary-foreground text-center align-middle px-2 py-0`}>Oficina Comercial</TableHead>
              {ROLES.map(role => (
                <TableHead key={role} colSpan={2} className={`text-center font-bold text-primary-foreground border-b border-primary-foreground border-r border-l px-2 py-0`}>{role}</TableHead>
              ))}
              <TableHead rowSpan={2} className={`text-center font-bold text-primary-foreground align-middle border-b border-primary-foreground px-2 py-0`}>Atrasos</TableHead>
              <TableHead rowSpan={2} className={`text-center font-bold text-primary-foreground align-middle border-b border-primary-foreground px-2 py-0`}>Ausentes</TableHead>
          </TableRow>
          <TableRow className="border-0">
              {ROLES.map(role => (
                <React.Fragment key={role}>
                    <TableHead className={`text-center font-bold text-primary-foreground border-b border-primary-foreground border-r px-2 py-0`}>Real</TableHead>
                    <TableHead className={`text-center font-bold text-primary-foreground border-b border-primary-foreground border-r px-2 py-0`}>Teóri.</TableHead>
                </React.Fragment>
              ))}
          </TableRow>
        </TableHeader>
